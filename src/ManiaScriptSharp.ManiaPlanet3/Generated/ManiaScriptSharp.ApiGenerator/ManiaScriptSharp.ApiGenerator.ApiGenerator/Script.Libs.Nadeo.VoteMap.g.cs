...
public partial class VoteMap : ILib
{
    ...
    public const string ScriptName = "VoteMap.Script.txt";
    ...
    public void Begin(CMapInfo[] _Maps, int _VoteDuration, int _ResultDuration) { }
    ...
    /// <summary>Get the MapInfo of the next map</summary>
    /// <returns>The MapInfo of the next map</returns>
    public CMapInfo GetNextMapInfo() => default!;
