...
public partial class Interface : ILib
{
    ...
    /// <param name="Player">The player who'll see the slider</param>
    /// <param name="Delay">The delay before the display of the slider</param>
    ...
    /// <param name="Duration">The new duration of the pause</param>
