...
public partial class MultiClans2 : ILib
{
    ...
    public int GetClan(CSmPlayer _Player) => default!;
    ...
    public void SetClan(CSmPlayer _Player, int _ClanNb) { }
