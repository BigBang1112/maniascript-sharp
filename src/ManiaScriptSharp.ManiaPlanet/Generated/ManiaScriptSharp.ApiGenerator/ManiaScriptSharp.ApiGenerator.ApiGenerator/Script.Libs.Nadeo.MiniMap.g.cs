...
public partial class MiniMap : ILib
{
    ...
    public global::System.Collections.Generic.Dictionary<CPlayer, Vec3> GetClicPos() => default!;

    public global::System.Collections.Generic.Dictionary<CPlayer, string> GetClicPointId() => default!;

    public bool GetPointVisibility(CPlayer _Player, string _PointId) => default!;

    public Vec3 GetPointColor(CPlayer _Player, string _PointId) => default!;

    public string GetPointImage(CPlayer _Player, string _PointId) => default!;
