...
public partial class Interface : ILib
{
    ...
    /// <summary>Deprecated - Use the rank functions instead Update a player position UI</summary>
    /// <param name="_Player">The player to update</param>
    public void UpdatePosition(CPlayer _Player) { }
    ...
    /// <summary>Display the slider for a player</summary>
    /// <param name="_Player">The player who'll see the slider</param>
    /// <param name="_Delay">The delay before the display of the slider</param>
    public void ShowSlider(CPlayer _Player, int _Delay) { }

    /// <summary>Hide the slider for a player</summary>
    /// <param name="_Player">The player who'll see the slider</param>
    /// <param name="_Delay">The delay before the display of the slider</param>
    public void HideSlider(CPlayer _Player, int _Delay) { }

    /// <summary>Change the pause duration on slides</summary>
    /// <param name="_Player">The affected player</param>
    /// <param name="_Duration">The new duration of the pause</param>
    public void SetSliderPause(CPlayer _Player, int _Duration) { }
