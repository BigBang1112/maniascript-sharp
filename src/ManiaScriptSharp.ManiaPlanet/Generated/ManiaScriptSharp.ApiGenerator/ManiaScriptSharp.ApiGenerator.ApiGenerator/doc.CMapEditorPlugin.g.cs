...
public partial class CMapEditorPlugin : CManiaApp, ILocalProvider, IPersistentProvider
{
    ...
    public ShadowsQuality CurrentShadowsQuality { get; set; }
    ...
    public bool EditorInputIsDown_SaveAs { get; set; }
    public bool EditorInputIsDown_MapStyle { get; set; }
    public bool EditorInputIsDown_ClassicMapEditor { get; set; }
