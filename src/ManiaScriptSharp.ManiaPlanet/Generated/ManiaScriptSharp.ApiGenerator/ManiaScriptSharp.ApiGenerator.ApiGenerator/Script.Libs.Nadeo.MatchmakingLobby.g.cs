...
public partial class MatchmakingLobby : ILib
{
    ...
    public global::ManiaScriptSharp.Scripts.Libs.Nadeo.XmlRpcCommon XmlRpc_Deprecated;
    ...
    /// <summary>Get the lobby phase constants</summary>
    public int LobbyPhase_Playing() => default!;
    ...
    public void SendReadyState(CPlayer _Player, bool _IsReady, string _ResponseId) { }

    /// <summary>Find and send the ready state of a player</summary>
    /// <param name="Player">The player to check</param>
    public void SendReadyState(CPlayer _Player, string _ResponseId) { }
    ...
    /// <summary>Enable or disable the masters list for the given player</summary>
    /// <param name="Player">The player to update</param>
    /// <param name="Enabled">True to enable, False to disable</param>
    public void EnableMastersList(CPlayer _Player, bool _Enabled) { }

    /// <summary>Enable or disable the masters list for the given player based on the LibMMLobby_MastersListDisabledFor array</summary>
    /// <param name="Player">The player to update</param>
    public void UpdateMastersListDisabledFor(CPlayer _Player) { }
    ...
    /// <summary>Check if a player is reading the game mode's rules or taking the quiz False otherwise</summary>
    /// <param name="Player">The player to check</param>
    /// <returns>True if the player is reading the rules or taking the quiz</returns>
    public bool IsDisplayingRulesOrQuiz(CPlayer _Player) => default!;
