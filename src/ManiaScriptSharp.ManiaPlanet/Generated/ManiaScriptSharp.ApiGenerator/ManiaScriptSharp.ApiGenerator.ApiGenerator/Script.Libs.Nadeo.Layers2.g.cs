...
public partial class Layers2 : ILib
{
    ...
    /// <param name="Player">The player to attach the layer with,</param>
    ...
    /// <param name="Player">The player to detach the layer from,</param>
    ...
    /// <param name="Player">The player to detach the layers from,</param>
