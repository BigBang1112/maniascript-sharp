...
public partial class Layers2 : ILib
{
    ...
    /// <summary>Attach a layer to one player or to all players if Null then attach to all players</summary>
    /// <param name="_LayerName">The name of the layer to attach</param>
    /// <param name="_Player">The player to attach the layer with,</param>
    ...
    /// <summary>Detach a layer from one player or from all players if Null then detach from all players</summary>
    /// <param name="_LayerName">The name of the layer to detach</param>
    /// <param name="_Player">The player to detach the layer from,</param>
    ...
    /// <summary>Detach all the layers from a player or the global UI if Null then detach from all players</summary>
    /// <param name="_Player">The player to detach the layers from,</param>
    ...
    /// <summary>DetachAll() overload, detach all the layers created by the lib from one player or the global UI if Null then detach from all players</summary>
    /// <param name="_Player">The player to detach the layers from,</param>
