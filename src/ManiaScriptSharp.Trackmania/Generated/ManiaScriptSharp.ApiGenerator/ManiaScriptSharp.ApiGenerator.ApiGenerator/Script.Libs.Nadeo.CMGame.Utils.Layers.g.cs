...
public partial class Layers : ILib
{
    ...
    public const string ScriptName = "Libs/Nadeo/CMGame/Utils/Layers.Script.txt";
    ...
    /// <summary>Set the attachId of a layer</summary>
    /// <param name="_LayerName">The name of the layer</param>
    /// <param name="_LayerAttachId">The attachId of layer to set</param>
    public void SetAttachId(string _LayerName, string _LayerAttachId) { }
