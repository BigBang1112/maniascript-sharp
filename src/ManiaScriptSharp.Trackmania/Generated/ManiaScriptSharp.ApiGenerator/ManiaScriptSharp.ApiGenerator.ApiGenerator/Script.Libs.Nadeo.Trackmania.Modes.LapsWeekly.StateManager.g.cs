...
namespace ManiaScriptSharp.Scripts.Libs.Nadeo.Trackmania.Modes.LapsWeekly;

/// <summary>State manager for the Laps Weekly mode</summary>
public partial class StateManager : ILib
{
    ...
    public global::ManiaScriptSharp.Scripts.Libs.Nadeo.Trackmania.Modes.LapsWeekly.UIModules.WelcomePopUp_Server UIModules_WelcomePopUp;

    public const string Version = "1.0.0";
    public const string ScriptName = "Libs/Nadeo/Trackmania/Modes/LapsWeekly/StateManager.Script.txt";
