...
public partial class CTitleControl : CNod
{
    ...
    public System.Collections.Generic.IList<string> CustomResultData { get; set; }
    ...
    public void PlayMapList(System.Collections.Generic.IList<string> MapList, string Mode, string SettingsXml) { }
    ...
    public void PlaySplitScreen(CTitleControl.ESplitScreenLayout LayoutType, System.Collections.Generic.IList<string> MapList, string Mode, string SettingsXml) { }
    public void PlayMultiOnSameScreen(System.Collections.Generic.IList<string> MapList, string Mode, string SettingsXml) { }
    ...
    public void EditReplay(System.Collections.Generic.IList<string> ReplayList) { }
    public void EditReplay(System.Collections.Generic.IList<string> ReplayList, CTitleControl.EReplayEditType EditType) { }
    ...
    public void EditMap(string Map, string Decoration, string ModNameOrUrl, string PlayerModel, System.Collections.Generic.IList<string> EditorPluginsScripts, System.Collections.Generic.IList<string> EditorPluginsArguments, bool UpgradeToAdvancedEditor) { }
    public void EditMap(string Map, string Decoration, string ModNameOrUrl, string PlayerModel, System.Collections.Generic.IList<string> EditorPluginsScripts, System.Collections.Generic.IList<string> EditorPluginsArguments, bool UpgradeToAdvancedEditor, bool OnlyUseForcedPlugins) { }
    ...
    public void EditNewMap(string Environment, string Decoration, string ModNameOrUrl, string PlayerModel, string MapType, bool UseSimpleEditor, System.Collections.Generic.IList<string> EditorPluginsScripts, System.Collections.Generic.IList<string> EditorPluginsArguments) { }
    public void EditNewMap(string Environment, string Decoration, string ModNameOrUrl, string PlayerModel, string MapType, bool UseSimpleEditor, System.Collections.Generic.IList<string> EditorPluginsScripts, System.Collections.Generic.IList<string> EditorPluginsArguments, bool OnlyUseForcedPlugins) { }
    ...
    public void EditNewMapFromBaseMap(string BaseMapName, string Decoration, string ModNameOrUrl, string PlayerModel, string MapType, System.Collections.Generic.IList<string> EditorPluginsScripts, System.Collections.Generic.IList<string> EditorPluginsArguments, bool OnlyUseForcedPlugins) { }
    ...
    public System.Collections.Generic.IList<CServerInfo> LocalServers { get; }
    public System.Collections.Generic.IList<CServerInfo> LocalServers_CurrentTitle { get; }
