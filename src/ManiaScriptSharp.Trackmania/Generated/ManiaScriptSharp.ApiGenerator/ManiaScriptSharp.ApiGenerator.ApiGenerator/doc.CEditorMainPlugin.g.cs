...
public partial class CEditorMainPlugin : CAnyEditorPlugin, ILocalProvider, IPersistentProvider
{
    ...
    public void SendPluginEvent(CEditorPluginHandle Handle, string Type, System.Collections.Generic.IList<string> Data) { }
    ...
    public System.Collections.Generic.IList<CEditorPluginHandle> Plugins { get; }
    public void Module_Load(string ModuleName) { }
    public System.Collections.Generic.IList<CGameModuleEditorBase> Modules { get; }
