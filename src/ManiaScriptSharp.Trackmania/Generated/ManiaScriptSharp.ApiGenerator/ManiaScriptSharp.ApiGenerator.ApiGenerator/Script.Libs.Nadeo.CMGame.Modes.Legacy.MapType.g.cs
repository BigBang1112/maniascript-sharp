...
public partial class MapType : ILib
{
    ...
    public const string ScriptName = "Libs/Nadeo/CMGame/Modes/Legacy/MapType.Script.txt";
    ...
    /// <summary>Check if the objectives respawns are valid For the time being this function should always return True because the values set in the TMObjectives variables are automatically checked by the game and sanitized when necessary.</summary>
    /// <returns>True if the objectives are valid, false otherwise</returns>
    public bool PlatformObjectivesAreValid() => default!;
}
