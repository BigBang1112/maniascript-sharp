...
/// <summary>State manager for the Round Boulet mode</summary>
public partial class StateManager : ILib
{
    ...
    public const string ScriptName = "Libs/Nadeo/Trackmania/Modes/RoundsBoulet/StateManager.Script.txt";
    public const bool C_ForceStatesEveryFrame = false;
    public const int C_State_Waiting = 0;
    public const int C_State_Playing = 1;
    public const int C_State_RaceRanking = 2;
