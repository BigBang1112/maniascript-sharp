...
namespace ManiaScriptSharp.Scripts.Libs.Nadeo.Trackmania.Modes.MultiTeams;

/// <summary>State manager for the Multi-Teams mode</summary>
public partial class StateManager : ILib
{
    ...
    public const string ScriptName = "Libs/Nadeo/Trackmania/Modes/MultiTeams/StateManager.Script.txt";
