...
public partial class Http_2 : ILib
{
    ...
    public const string ScriptName = "Libs/Nadeo/CMGame/Utils/Http@2.Script.txt";
    public const int C_Status_Null = 0;
    public const int C_Status_WaitingSlot = 1;
    public const int C_Status_WaitingDebounce = 2;
    public const int C_Status_Processing = 3;
    public const int C_Status_WaitingExternalComplete = 4;
    public const int C_Status_Complete = 5;
    public const int C_Status_Destroyed = 6;
    public const int C_Method_Get = 0;
    public const int C_Method_Post = 1;
    public const int C_Method_Put = 2;
    public const int C_MinimumAvailableSlotsNb = 5;
    public const bool C_EnableCppCache = false;
    public const bool C_Default_OfflineModeEnabled = false;
    public const int C_DebounceDuration = 2500;
    ...
    {
        public Ident HttpRequestId;
        public int Status;
        public string Url;
        public K_RequestOptions Options;
        public string Result;
        public int ResponseStatusCode;
        public int DebounceTimer;
        public int ResponseDelayEndTime;
        public bool IsFake;
    }
