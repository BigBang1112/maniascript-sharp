...
{
    private readonly Func<CodeContext, HBlock>[] hBlocks = new Func<CodeContext, HBlock>[]
    {
    ...
    public void Execute(GeneratorExecutionContext context)
    {
        ...
        var codeContext = new CodeContext(maniaScriptSharpGameTypes);

        var hashset = new HashSet<string>();

        foreach (var sourceFile in BuildSourceCodeFiles(docHFile, codeContext))
        {
    ...
    internal IEnumerable<SourceCodeFile> BuildSourceCodeFiles(string? docHFile, CodeContext context)
    {
    ...
    internal SourceCodeFile? BuildSourceCodeFile(StreamReader reader, CodeContext context)
    {
